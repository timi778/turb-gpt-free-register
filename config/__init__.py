...
__all__ = [
    ...
    # register
    "REGISTER_EMAIL", "REGISTER_PASSWORD", "REGISTER_PASSWORD_MODE", "SET_PASSWORD_AFTER_REGISTRATION", "REGISTER_NAME",
    # email
    ...
    "REMAIL_API_KEY", "REMAIL_SERVICE_MODE", "REMAIL_PROJECT_ID", "REMAIL_PRODUCT_ID", "REMAIL_EMAIL_SUFFIXES",
